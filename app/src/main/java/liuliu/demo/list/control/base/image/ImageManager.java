...
import static liuliu.demo.list.base.BaseApplication.newInstance;

/**
 * Created by Administrator on 2016/1/5.
 */
public class ImageManager implements ImageLoader.ImageCache {
    //缓存类
    ...
    public ImageManager() {
        ...
        try {
            // 获取DiskLruCahce对象
            mDiskLruCache = DiskLruCache.open(getDiskCacheDir(newInstance(), "Rabbit"), getAppVersion(newInstance()), 1, DISKMAXSIZE);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
